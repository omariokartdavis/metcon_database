...
class Workout(models.Model):
        ...
        classification = models.ForeignKey(Classification, default=3, blank=True, null=True, on_delete=models.CASCADE) #had to run makemigrations and migrate after making the blank=true null=True change to allow for no classifications when creating a workout model
